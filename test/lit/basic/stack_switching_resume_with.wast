...
(module
 ...
 ;; CHECK-TEXT:      (type $4 (func (param i32) (result i32)))

 ;; CHECK-TEXT:      (type $5 (func (param (ref $ct)) (result i32)))

 ;; CHECK-TEXT:      (tag $t (type $4) (param i32) (result i32))
 ;; CHECK-BIN:      (type $3 (func (result i32 (ref $ct))))

 ;; CHECK-BIN:      (type $4 (func (param i32) (result i32)))

 ;; CHECK-BIN:      (type $5 (func (param (ref $ct)) (result i32)))

 ;; CHECK-BIN:      (tag $t (type $4) (param i32) (result i32))
 (tag $t (param i32) (result i32))

 ;; CHECK-TEXT:      (func $go (type $5) (param $x (ref $ct)) (result i32)
 ;; CHECK-TEXT-NEXT:  (tuple.extract 2 0
 ;; CHECK-TEXT-NEXT:   (block $handler (type $3) (result i32 (ref $ct))
 ;; CHECK-TEXT-NEXT:    (return
 ;; CHECK-TEXT-NEXT:     (resume_with $ct (on $t $handler)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $go (type $5) (param $x (ref $ct)) (result i32)
 ...
 ;; CHECK-BIN-NEXT:       (resume_with $ct (on $t $block)
...
;; CHECK-BIN-NODEBUG:      (type $1 (func (param i32 (ref $0)) (result i32)))

;; CHECK-BIN-NODEBUG:      (type $2 (cont $1))

;; CHECK-BIN-NODEBUG:      (type $3 (func (result i32 (ref $2))))

;; CHECK-BIN-NODEBUG:      (type $4 (func (param i32) (result i32)))

;; CHECK-BIN-NODEBUG:      (type $5 (func (param (ref $2)) (result i32)))

;; CHECK-BIN-NODEBUG:      (tag $tag$0 (type $4) (param i32) (result i32))

;; CHECK-BIN-NODEBUG:      (func $0 (type $5) (param $0 (ref $2)) (result i32)
;; CHECK-BIN-NODEBUG-NEXT:  (local $scratch (tuple i32 (ref $2)))
...
;; CHECK-BIN-NODEBUG-NEXT:     (block $block (type $3) (result i32 (ref $2))
;; CHECK-BIN-NODEBUG-NEXT:      (return
;; CHECK-BIN-NODEBUG-NEXT:       (resume_with $2 (on $tag$0 $block)
